...
const caret = {
    d: "M12 6.5c0-.28-.22-.5-.5-.5h-7c-.28 0-.5.22-.5.5 0 .13.05.24.13.33l3.5 4c.09.1.22.17.37.17s.28-.07.37-.17l3.5-4c.08-.09.13-.2.13-.33z"
};
...
const SelectWithRef = <T,>(props: Props<T>, ref?: Ref) => {
    ...
    return (
        <div className={getContainerCls(props)} ref={ref}>
            ...
            <span className={s.icon}><IconC icon={caret} /></span>
        </div>
    )
};
