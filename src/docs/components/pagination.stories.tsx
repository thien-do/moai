 ...
 * In these cases, return a [`Promise`][1] in the `setValue` callback
 * to have the pagination displays a loading state while waiting for data.
 *
 ...
 * In these cases, it's recommended to use zero-based counting for your state and most logic,
